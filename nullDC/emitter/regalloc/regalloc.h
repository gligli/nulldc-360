...
{
	public :
#define T ppc_gpr_reg
	//DoAllocation		: do allocation on the block
	virtual void DoAllocation(BasicBlock* bb,ppc_block* x86e)=0;
...
#define T ppc_fpr_reg
	...
	virtual void FlushRegister_xmm(ppc_fpr_reg reg)=0;
	virtual void SaveRegisterGPR(u32 to,ppc_reg from)=0;
	virtual void LoadRegisterGPR(ppc_reg to,u32 from)=0;
#undef T
};
