...
void pvr_sb_Init()
{
	...
	sb_regs[(u32)((SB_PDST_addr-SB_BASE))>>2].flags=REG_32BIT_READWRITE | REG_READ_DATA;
	sb_regs[(u32)((SB_PDST_addr-SB_BASE))>>2].readFunction=0;
	sb_regs[(u32)((SB_PDST_addr-SB_BASE))>>2].writeFunction=RegWrite_SB_PDST;
	sb_regs[(u32)((SB_PDST_addr-SB_BASE))>>2].data32=&SB_PDST;

	//0x005F6808	SB_C2DST	RW	ch2-DMA start 
	sb_regs[(u32)((SB_C2DST_addr-SB_BASE))>>2].flags=REG_32BIT_READWRITE | REG_READ_DATA;
	sb_regs[(u32)((SB_C2DST_addr-SB_BASE))>>2].readFunction=0;
	sb_regs[(u32)((SB_C2DST_addr-SB_BASE))>>2].writeFunction=RegWrite_SB_C2DST;
	sb_regs[(u32)((SB_C2DST_addr-SB_BASE))>>2].data32=&SB_C2DST;


	//0x005F6820	SB_SDST	RW	Sort-DMA start
	sb_regs[(u32)((SB_SDST_addr-SB_BASE))>>2].flags=REG_32BIT_READWRITE | REG_READ_DATA;
	sb_regs[(u32)((SB_SDST_addr-SB_BASE))>>2].readFunction=0;
	sb_regs[(u32)((SB_SDST_addr-SB_BASE))>>2].writeFunction=RegWrite_SB_SDST;
